        ...
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        <h3 class="page-title">الفئات الفرعية</h3>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><router-link :to="{name: 'indexSubCategory'}">الفئات الفرعية</router-link></li>
                            <li class="breadcrumb-item active">تعديل الفئه الفرعية</li>
                        </ul>
                    </div>
                </div>
            </div>
                                    ...
                                    <form @submit.prevent="editSupplier" class="needs-validation">
                                        <div class="form-row row">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                <label for="validationCustom01">اسم الفئه الفرعية</label>
                                                <input type="text" class="form-control"
                                                       v-model.trim="v$.name.$model"
                                                       id="validationCustom01"
                                                       placeholder="اسم الفئه الفرعية"
                                            ...
                                            <div class="col-md-6 mb-3">
                                                <label >اختر الفئه الرئيسية</label>
                                                <select
                                                    name="type"
                                                    class="form-control"
                                                ...
                                                <div class="valid-feedback">تبدو جيده</div>
                                                <div class="invalid-feedback">
                                                    <span v-if="v$.parent_id.required.$invalid"> هذا الحقل مطلوب<br /> </span>
                                                </div>
                                            </div>
...
export default {
    ...
    setup(props){
        ...
        let getCategory = () => {
            ...
            adminApi.get(`/v1/dashboard/subCategory/${id.value}/edit`)
                .then((res) => {
                    ...
                    addCategory.data.parent_id = l.category.parent_id;
        ...
        return {id,categories,loading,...toRefs(addCategory),v$,preview,numberOfImage,image};
    },
    methods: {
        editSupplier(){
            this.v$.$validate();
