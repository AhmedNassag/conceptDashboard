                                ...
                                <table class="table mb-0">
                                    ...
                                    <tr v-for="(item,index) in measures"  :key="item.id">
                                        ...
                                        <td>
                                            ...
                                            <router-link
                                                :to="{name: 'editLeadSourse',params:{id:item.id}}"
...
export default {
    ...
    setup() {
        ...
        let getMeasure = (page = 1) => {
            ...
            adminApi.get(`/v1/dashboard/leadSourse?page=${page}&search=${search.value}`)
                .then((res) => {
                    let l = res.data.data;
                    measuresPaginate.value = l.leadSourses;
                    measures.value = l.leadSourses.data;
                })
                .catch((err) => {
        ...
        function deleteMeasure(id, index) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    adminApi.delete(`/v1/dashboard/leadSourse/${id}`)
                        .then((res) => {
