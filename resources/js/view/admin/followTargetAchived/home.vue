        ...
        <div class="content container-fluid">
            ...
            <div class="row">
                <div class="col-md-6" v-for="item in targets" :key="item.id">
                    <div class="card">
                        <router-link v-if="permission.includes('followLeads read')" :to="{name: 'indexfollowTargetAchieved', params: {lang: locale || 'ar',id:item.id}}" class="btn btn-sm btn-category">
                            <h3>{{item.name}}</h3>
                        </router-link>
                    </div>
                </div>
