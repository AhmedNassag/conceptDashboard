                ...
                <div class="row align-items-center">
                    <div class="col">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">
                                <router-link :to="{name: 'indexProblemTargetAchievedHome', params: {lang: locale || 'ar',id}}">
                            ...
                            <div class="card-header pt-0">
                                <div class="row justify-content-between">
                                    ...
                                    <div class="col-2 row justify-content-end">
                                        <router-link v-if="permission.includes('problemTargetAchieved create')" :to="{name: 'createProblemTargetAchieved', params: {lang: locale || 'ar'}}" class="btn btn-custom btn-warning">
                                            {{ $t('global.Add') }}
                                        </router-link>
                                    </div>
                                </div>
                                ...
                                <table class="table mb-0">
                                    ...
                                    <tr v-for="(item,index) in leads" :key="item.id">
                                        ...
                                        <td>
                                            ...
                                            <router-link :to="{name: 'editProblemTargetAchieved', params: {lang: locale || 'ar',idTarget:id,idLead:item.id}}" v-if="permission.includes('problemTargetAchieved edit')" class="btn btn-sm btn-success me-2">
                                                <i class="far fa-edit"></i>
                                            </router-link>

                                            <a href="#" @click="deleteLead(item.id,item.employee.user.name,index)" v-if="permission.includes('problemTargetAchieved delete')" data-bs-target="#staticBackdrop" class="btn btn-sm btn-danger me-2">
...
export default {
    ...
    setup(props) {
        ...
        let getLead = (page = 1) => {
            ...
            adminApi.get(`/v1/dashboard/problemtargetAchieved/${id.value}?page=${page}&search=${search.value}`)
                .then((res) => {
                    let l = res.data.data;
        ...
        function deleteLead(id, incomeName, index) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    adminApi.delete(`/v1/dashboard/problemtargetAchieved/${id}`)
                        .then((res) => {
