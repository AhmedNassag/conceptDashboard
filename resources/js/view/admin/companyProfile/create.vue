                ...
                <div class="row align-items-center">
                    <div class="col">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">إضافة ملف الشركة</li>
                        </ul>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-sm">
                                    ...
                                    <form @submit.prevent="storeCompanyProfile" class="needs-validation">
...
export default {
    ...
    setup(){
        ...
        return {loading,...toRefs(addCompanyProfile),v$,preview,numberOfImage};
    },
    methods: {
        storeCompanyProfile(){
            this.v$.$validate();
            ...
            if(!this.v$.$error){
                ...
                adminApi.post(`/v1/dashboard/companyProfile`,formData)
                    .then((res) => {
