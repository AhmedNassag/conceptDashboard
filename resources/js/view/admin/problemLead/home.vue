        ...
        <div class="content container-fluid">
            ...
            <div class="row">
                <div class="col-md-6" v-for="item in targets" :key="item.id">
                    <div class="card">
                        <router-link v-if="permission.includes('problemLeads read')"
                            :to="{name: 'indexProblemLead', params: {lang: locale || 'ar',id:item.id}}"
...
export default {
    ...
    setup() {
        ...
        let getTarget = (page = 1) => {
            ...
            adminApi.get(`/v1/dashboard/problemsalesLead?page=${page}&search=${search.value}`)
                .then((res) => {
                    let l = res.data.data;
                    console.log(l)
