                ...
                <div class="row align-items-center">
                    <div class="col">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">{{ $t('global.problemLeads') }}</li>
                        </ul>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="card-header pt-0">
                                <div class="row justify-content-between">
                                    ...
                                    <div class="col-4 row justify-content-end">
                                        <router-link
                                            v-if="permission.includes('problemLeads create')"
                                            :to="{name: 'createProblemLead', params: {lang: locale || 'ar'}}"
                                ...
                                <table class="table mb-0">
                                    ...
                                    <tr v-for="(item,index) in leads" :key="item.id">
                                        ...
                                        <td class="text-center">
                                            ...
                                            <router-link
                                                :to="{name: 'editProblemLead', params: {lang: locale || 'ar',idTarget:id,idLead:item.id}}"
                                                v-if="permission.includes('problemLeads edit')"
...
<!--                                            </a>-->
                                            ...
                                            <router-link
                                                :to="{name: 'indexProblemLeadComment', params: {lang: locale || 'ar',id:item.id}}"
...
export default {
    ...
    setup(props) {
        ...
        let getLead = (page = 1) => {
            ...
            adminApi.get(`/v1/dashboard/problemsalesLead/${id.value}?page=${page}&search=${search.value}`)
                .then((res) => {
                    let l = res.data.data;
        ...
        function addTenLead(id) {
            adminApi.get(`/v1/dashboard/problemgetTenLead/${id}`)
                .then((res) => {
                    let l = res.data.data;
                    console.log(l);
                    getLead();
        ...
        function deleteLead(id, incomeName, index) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    adminApi.delete(`/v1/dashboard/problemsalesLead/${id}`)
                        .then((res) => {
