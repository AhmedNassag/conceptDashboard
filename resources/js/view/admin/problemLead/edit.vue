                ...
                <div class="row align-items-center">
                    <div class="col">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">
                                <router-link :to="{name: 'indexProblemLead', params: {lang: locale || 'ar',id:idTarget}}">
                                    {{$t('global.Leads')}}
                                </router-link>
                            </li>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="card-header pt-0 mb-4">
                                <router-link
                                    :to="{name: 'indexProblemLead', params: {lang: locale || 'ar',id:idTarget}}"
...
export default {
    ...
    setup(props){
        ...
        let getLead = () => {
            ...
            adminApi.get(`/v1/dashboard/problemsalesLead/${idLead.value}/edit`)
                .then((res) => {
                    let l = res.data.data;
    ...
    methods: {
        editLead(){
            ...
            if(!this.v$.$error){
                ...
                adminApi.put(`/v1/dashboard/problemsalesLead/${this.idLead}`,this.data)
                    .then((res) => {
