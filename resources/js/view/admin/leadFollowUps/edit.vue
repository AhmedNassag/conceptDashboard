            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        ...
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><router-link :to="{name: 'indexLeadFollowUps'}">{{ $t('sidebar.LeadFollowUps') }}</router-link></li>
...
export default {
    ...
    setup(props){
        ...
        let getMeasure = () => {
            ...
            adminApi.get(`/v1/dashboard/leadFollowUps/${id.value}/edit`)
                .then((res) => {
                    let l = res.data.data;
                    addMeasure.data.name = l.leadFollowUp.name;
                })
                .catch((err) => {
    ...
    methods: {
        editMeasure(){
            ...
            if(!this.v$.$error){
                ...
                adminApi.put(`/v1/dashboard/leadFollowUps/${this.id}`,this.data)
                    .then((res) => {
