            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        ...
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><router-link :to="{name: 'indexKnowledge'}">{{$t('global.Department')}}</router-link></li>
    ...
    methods: {
        storeDepartment(){
            ...
            if(!this.v$.$error){
                ...
                adminApi.post(`/v1/dashboard/knowledgeWay`,this.data)
                    .then((res) => {
