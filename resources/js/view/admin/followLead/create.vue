                ...
                <div class="row align-items-center">
                    <div class="col">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">
                                <router-link :to="{name: 'indexfollowLead', params: {lang: locale || 'ar',id}}">
                                    {{$t('global.Leads')}}
                                </router-link>
                            </li>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="card-header pt-0 mb-4">
                                <router-link
                                    :to="{name: 'indexfollowLead', params: {lang: locale || 'ar',id}}"
    ...
    methods: {
        storeLead(){
            ...
            if(!this.v$.$error){
                ...
                adminApi.post(`/v1/dashboard/followsalesLead`,this.data)
                    .then((res) => {
