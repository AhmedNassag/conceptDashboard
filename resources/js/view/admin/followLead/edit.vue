                ...
                <div class="row align-items-center">
                    <div class="col">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">
                                <router-link :to="{name: 'indexfollowLead', params: {lang: locale || 'ar',id:idTarget}}">
                                    {{$t('global.Leads')}}
                                </router-link>
                            </li>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="card-header pt-0 mb-4">
                                <router-link
                                    :to="{name: 'indexfollowLead', params: {lang: locale || 'ar',id:idTarget}}"
                                    ...
                                    <form @submit.prevent="editLead" class="needs-validation">
                                        <div class="form-row row">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <div class="valid-feedback">{{ $t('global.LooksGood') }}</div>
                                                <div class="invalid-feedback">
                                                    <span v-if="v$.description.description.$invalid">{{ $t('global.NameIsRequired') }}<br/></span>
                                                </div>
                                            </div>
...
export default {
    ...
    setup(props){
        ...
        let getLead = () => {
            ...
            adminApi.get(`/v1/dashboard/followsalesLead/${idLead.value}/edit`)
                .then((res) => {
                    let l = res.data.data;
                    addLead.data.name = l.lead.name;
                    addLead.data.address = l.lead.address;
                    addLead.data.phone = l.lead.phone;
                    addLead.data.description = l.lead.description;
                })
                .catch((err) => {
    ...
    methods: {
        editLead(){
            ...
            if(!this.v$.$error){
                ...
                adminApi.put(`/v1/dashboard/followsalesLead/${this.idLead}`,this.data)
                    .then((res) => {
