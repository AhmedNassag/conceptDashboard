                                ...
                                <div class="row justify-content-between">
                                    ...
                                    <div class="col-5 row justify-content-end">
                                        <router-link
                                            ...
                                            v-if="permission.includes('Complaints create')"
                                ...
                                <table class="table mb-0">
                                    ...
                                    <tbody v-if="jobs.length">
                                        <tr v-for="(item,index) in jobs" :key="item.id">
                                            ...
                                            <td>
                                                <router-link
                                                    :to="{name: 'editComplaint', params: {id:item.id}}"
                                                    v-if="permission.includes('Complaints edit')"
                                                    class="btn btn-sm btn-success me-2">
                                                    <i class="far fa-edit"></i>
                                                </router-link>
                                                <a href="#" @click="deleteJob(item.id,item.name,index)"
                                                   v-if="permission.includes('Complaints delete')"
...
export default {
    ...
    setup() {
        ...
        let getJob = (page = 1) => {
            ...
            adminApi.get(`/v1/dashboard/complaint?page=${page}&search=${search.value}`)
                .then((res) => {
                    let l = res.data.data;
        ...
        function deleteJob(id, jobName, index) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    adminApi.delete(`/v1/dashboard/complaint/${id}`)
                    .then((res) => {
