                    ...
                    <div class="col">
                        ...
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item">
                                <router-link :to="{name: 'nearPeriodicMaintenance', params: {lang: locale || 'ar'}}">
                                    جدول مواعيد الصيانات القريبة
                                </router-link>
                            </li>
                            <li class="breadcrumb-item active">تغيير الموظف</li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="card-header pt-0 mb-4">
                                <router-link :to="{name: 'nearPeriodicMaintenance', params: {lang: locale || 'ar'}}" class="btn btn-custom btn-dark">
                                    {{$t('global.back')}}
                                </router-link>
                            </div>
                            <div class="row">
...
export default {
    ...
    setup(props){
        ...
        let getLead = () => {
            ...
            adminApi.get(`/v1/dashboard/periodicchangeEmployeeLead/${id.value}`)
                .then((res) => {
                    let l = res.data.data;
                    console.log(l);
    ...
    methods: {
        editLead(){
            ...
            if(!this.v$.$error){
                ...
                adminApi.put(`/v1/dashboard/periodicupdateEmployeeLead/${this.id}`,this.data)
                .then((res) => {
