                                ...
                                <div class="col-sm">
                                    <form @submit.prevent="editPeriodicMaintenance" class="needs-validation">
                                        <div class="form-row row">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                <label for="validationCustom01">موعد الصيانة الجديد</label>
                                            ...
                                            <div class="col-md-6 mb-3">
                                                <label for="validationCustom01">سبب التأجيل</label>
                                                ...
                                                <div class="valid-feedback">تبدو جيده</div>
                                                <div class="invalid-feedback">
                                                    <span v-if="v$.note.required.$invalid"> هذا الحقل مطلوب<br /> </span>
                                                </div>
                                            </div>
