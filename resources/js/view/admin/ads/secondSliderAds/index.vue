                                ...
                                <div class="row justify-content-between">
                                    ...
                                    <div class="col-5 row justify-content-end">
                                        <router-link
                                            ...
                                            v-if="permission.includes('secondSliderAds create')"
                            ...
                            <div class="table-responsive">
                                <table class="table mb-0">
                                    ...
                                    <tr v-for="(item,index) in ads" :key="item.id">
                                        ...
                                        <td>
                                            <img
                                                :src="'/upload/ads/' + item.media.file_name"
                                                :alt="item.name"
                                                class="custom-img"
                                            />
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <router-link
                                                ...
                                                v-if="permission.includes('secondSliderAds edit')"
                                                class="btn btn-sm btn-success me-2">
                                                <i class="far fa-edit"></i>
                                            </router-link>

                                            <a href="#" @click="deleteAds(item.id,index)"
                                               v-if="permission.includes('secondSliderAds delete')"
