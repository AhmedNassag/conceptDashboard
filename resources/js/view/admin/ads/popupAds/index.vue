        ...
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        <h3 class="page-title">{{ $t('global.popupAds') }}</h3>
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">{{ $t('global.popupAds') }}</li>
                        </ul>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="card-header pt-0">
                                <div class="row justify-content-between">
                                    ...
                                    <div class="col-5 row justify-content-end" v-if="ads.length == 0">
                                        <router-link
                                            :to="{name: 'createPopupAds'}"
                                            v-if="permission.includes('popupAds create')"
                            ...
                            <div class="table-responsive">
                                <table class="table mb-0">
                                    ...
                                    <tr v-for="(item,index) in ads" :key="item.id">
                                        ...
                                        <td>
                                            <img
                                                :src="'/upload/popupAds/' + item.media.file_name"
                                                :alt="item.name"
                                                class="custom-img"
                                            />
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <router-link
                                                :to="{name: 'editPopupAds', params: {id:item.id}}"
                                                v-if="permission.includes('popupAds edit')"
                                                class="btn btn-sm btn-success me-2">
                                                <i class="far fa-edit"></i>
                                            </router-link>

                                            <a href="#" @click="deleteAds(item.id,index)"
                                               v-if="permission.includes('popupAds delete')"
...
export default {
    ...
    setup() {
        ...
        let getAds = (page = 1) => {
            ...
            adminApi.get(`/v1/dashboard/popupAds?page=${page}&search=${search.value}`)
                .then((res) => {
                    let l = res.data.data;
        ...
        function deleteAds(id, index) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    adminApi.delete(`/v1/dashboard/popupAds/${id}`)
                        .then((res) => {
