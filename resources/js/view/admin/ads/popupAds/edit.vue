            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        ...
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><router-link :to="{name: 'indexPopupAds'}">{{$t('global.popupAds')}}</router-link></li>
                                        ...
                                        <div class="form-row row">
                                            ...
                                            <div class="col-md-6 mb-12 row flex-fill">
                                                ...
                                                <div class="container-images" v-show="!numberOfImage">
                                                    <figure>
                                                        <figcaption>
                                                            <img :src="`/upload/popupAds/${image.file_name}`">
                                                        </figcaption>
                                                    </figure>
                                                </div>
                                            </div>
...
export default {
    ...
    setup(props){
        ...
        let getMainEmployeeViews = () => {
            ...
            adminApi.get(`/v1/dashboard/popupAds/${id.value}/edit`)
                .then((res) => {
                    let l = res.data.data;
    ...
    methods: {
        editEmployee(){
            ...
            if(!this.v$.$error){
                ...
                adminApi.post(`/v1/dashboard/popupAds/${this.id}`,formData)
                    .then((res) => {
