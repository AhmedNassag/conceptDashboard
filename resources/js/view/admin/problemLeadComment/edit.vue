                    ...
                    <div class="col">
                        ...
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item">
                                <router-link :to="{name: 'indexProblemLeadComment', params: {lang: locale || 'ar',id:idTarget}}">
                                    {{$t('global.Comments')}}
                                </router-link>
                            </li>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="card-header pt-0 mb-4">
                                <router-link :to="{name: 'indexProblemLeadComment', params: {lang: locale || 'ar',id:idTarget}}" class="btn btn-custom btn-dark">
                                    {{$t('global.back')}}
                                </router-link>
                            </div>
                            <div class="row">
...
export default {
    ...
    setup(props){
        ...
        let getLead = () => {
            ...
            adminApi.get(`/v1/dashboard/problemleadComment/${idLead.value}/edit`)
                .then((res) => {
                    let l = res.data.data;
    ...
    methods: {
        editLead(){
            ...
            if(!this.v$.$error){
                ...
                adminApi.put(`/v1/dashboard/problemleadComment/${this.idLead}`,this.data)
                    .then((res) => {
