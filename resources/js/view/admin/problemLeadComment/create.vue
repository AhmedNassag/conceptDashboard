                    ...
                    <div class="col">
                        ...
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item">
                                <router-link :to="{name: 'indexProblemLeadComment', params: {lang: locale || 'ar',id}}">
                                    {{$t('global.Comments')}}
                                </router-link>
                            </li>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="card-header pt-0 mb-4">
                                <router-link :to="{name: 'indexProblemLeadComment', params: {lang: locale || 'ar',id}}" class="btn btn-custom btn-dark">
                                    {{$t('global.back')}}
                                </router-link>
                            </div>
                            <div class="row">
    ...
    methods: {
        storeLead(){
            ...
            if(!this.v$.$error){
                ...
                adminApi.post(`/v1/dashboard/problemleadComment`,this.data)
                    .then((res) => {
