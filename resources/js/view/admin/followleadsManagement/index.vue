        ...
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        <h3 class="page-title">{{ $t('global.followLeadsManagement') }}</h3>
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">{{ $t('global.followLeadsManagement') }}</li>
                        </ul>
                    </div>
                            ...
                            <div class="card-header pt-0">
                                <div class="row justify-content-between">
                                    ...
                                    <div class="col-2 row justify-content-end">
                                        <router-link v-if="permission.includes('followLeadsManagement create')" :to="{name: 'createfollowLeadsManagement', params: {lang: locale || 'ar'}}" class="btn btn-custom btn-warning">
                                            {{ $t('global.Add') }}
                                        </router-link>
                                    </div>
                                </div>
                                ...
                                <table class="table mb-0">
                                    ...
                                    <tr v-for="(item,index) in leads" :key="item.id">
                                        ...
                                        <td class="text-center">
                                            ...
                                            <router-link :to="{name: 'editfollowLeadsManagement', params: {lang: locale || 'ar',id:item.id}}" v-if="permission.includes('followLeadsManagement edit')" class="btn btn-sm btn-success me-2">
...
export default {
    ...
    setup() {
        ...
        let getLead = (page = 1) => {
            ...
            adminApi.get(`/v1/dashboard/followleads?page=${page}&search=${search.value}`)
                .then((res) => {
                    let l = res.data.data;
        ...
        function deleteLead(id, incomeName, index) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    adminApi.delete(`/v1/dashboard/followleads/${id}`)
                        .then((res) => {
