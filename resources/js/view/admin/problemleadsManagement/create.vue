                                ...
                                <div class="col-sm">
                                    ...
                                    <form @submit.prevent="storeLead" class="needs-validation">
                                        <div class="form-row row">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                <label for="validationCustom04">{{ $t('global.Problem Description') }}</label>
                                                <textarea type="text"
                                                    class="form-control"
...
export default {
    ...
    setup(){
        ...
        let getLeads = () => {
            ...
            adminApi.get(`/v1/dashboard/problemleads/create`)
            .then((res) => {
                let l = res.data.data;
    ...
    methods: {
        storeLead(){
            ...
            if(!this.v$.$error){
                ...
                adminApi.post(`/v1/dashboard/problemleads`,this.data)
                    .then((res) => {
