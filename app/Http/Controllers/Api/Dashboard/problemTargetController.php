...
class problemTargetController extends Controller
{
    use Message;
    ...
    public function store(Request $request)
    {
        try {
            ...
            problemTarget::create($request->all());
    ...
    {
        $targetPlan = problemTarget::where('seller_category_id',$id)->with('sellerCategory')
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(Request $request, problemTarget $target)
    {
        try
        {
     ...
     * @return \Illuminate\Http\Response
     */
    public function destroy(problemTarget $target)
    {
        $target->delete();
    }
}
