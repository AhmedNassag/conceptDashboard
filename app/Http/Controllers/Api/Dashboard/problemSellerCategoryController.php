...
class problemSellerCategoryController extends Controller
{
    use Message;
    ...
    {
        $employees = Employee::with('user:id,name','problemsellerCategories')->whereHas('problemsellerCategories')
...
//        return $employees;
    ...
    public function create()
    {
        ...
        })->whereDoesntHave('problemsellerCategories')->get();
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $employee->problemsellerCategories()->attach($data['seller_category_id']);
    ...
    public function edit($id)
    {
        try {
            ...
            $categories = problemSellerCategory::all();
            $targets = $employee->problemsellerCategories;
    ...
    public function update(Request $request,$id)
    {
        try {
            ...
            $employee->problemsellerCategories()->sync($data['seller_category_id']);
    ...
    public function destroy($id)
    {
        ...
        $employee->problemsellerCategories()->detach();
    }
}
