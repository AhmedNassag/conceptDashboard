...
class followTargetController extends Controller
{
    ...
    public function store(Request $request)
    {
        try {
            ...
            followTarget::create($request->all());
    ...
    {
        $targetPlan = followTarget::where('seller_category_id',$id)->with('sellerCategory')
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(Request $request, followTarget $target)
    {
        try
        {
     ...
     * @return \Illuminate\Http\Response
     */
    public function destroy(followTarget $target)
    {
        $target->delete();
    }
}
