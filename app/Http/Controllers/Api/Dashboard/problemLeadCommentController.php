...
use App\Models\problemLeadComment;
use App\Models\User;
...
class problemLeadCommentController extends Controller
{
    use Message;
    ...
    public function store(Request $request)
    {
        try {
            ...
            $v = Validator::make($request->all(), [
                ...
                'lead_id' => 'required|integer|exists:problem_leads,id',
            ]);
            ...
            problemLeadComment::create($data);
    ...
    public function edit($id)
    {
        try
        {
            $lead = problemLeadComment::find($id);
    ...
    {
        $comments = problemLeadComment::where('lead_id',$id)->with('employee.user')
    ...
    public function update(Request $request,$id)
    {
        try
        {
            $comment = problemLeadComment::find($id);
            DB::beginTransaction();
