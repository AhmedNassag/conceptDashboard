...
use App\Models\followLeadComment;
use App\Models\User;
...
class followLeadCommentController extends Controller
{
    use Message;
    ...
    public function store(Request $request)
    {
        try {
            ...
            $v = Validator::make($request->all(), [
                ...
                'lead_id' => 'required|integer|exists:follow_leads,id',
            ]);
    ...
    public function edit($id)
    {
        try
        {
            $lead = followLeadComment::find($id);
    ...
    {
        $comments = followLeadComment::where('lead_id',$id)->with('employee.user')
    ...
    public function update(Request $request,$id)
    {
        try
        {
            $comment = followLeadComment::find($id);
            DB::beginTransaction();
